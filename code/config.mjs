 ...
 */
export const abilityScores = Object.freeze({
  strength: {
 ...
 */
export const rationTypes = Object.freeze({
  animalFeed: {
 ...
 */
export const spellDurationTypes = Object.freeze({
  hours: {
 ...
 */
export const spellRangeTypes = Object.freeze({
  touch: {
...
export const terrainTypes = {
  grassland: {
    ...
    level: 1,
    difficulty: 6,
    icon: "systems/ryuutama/assets/official/icons/terrains/grassland.webp",
    iconSmall: "systems/ryuutama/assets/official/icons/terrains/grassland-sm.webp",
  },
  wasteland: {
    label: "RYUUTAMA.TERRAIN.wasteland",
    level: 1,
    difficulty: 6,
    icon: "systems/ryuutama/assets/official/icons/terrains/wasteland.webp",
    iconSmall: "systems/ryuutama/assets/official/icons/terrains/wasteland-sm.webp",
  },
  woods: {
    label: "RYUUTAMA.TERRAIN.woods",
    level: 2,
    difficulty: 8,
    icon: "systems/ryuutama/assets/official/icons/terrains/woods.webp",
    iconSmall: "systems/ryuutama/assets/official/icons/terrains/woods-sm.webp",
  },
  highlands: {
    label: "RYUUTAMA.TERRAIN.highlands",
    level: 2,
    difficulty: 8,
    icon: "systems/ryuutama/assets/official/icons/terrains/highlands.webp",
    iconSmall: "systems/ryuutama/assets/official/icons/terrains/highlands-sm.webp",
  },
  rocky: {
    label: "RYUUTAMA.TERRAIN.rocky",
    level: 2,
    difficulty: 8,
    icon: "systems/ryuutama/assets/official/icons/terrains/rocky.webp",
    iconSmall: "systems/ryuutama/assets/official/icons/terrains/rocky-sm.webp",
  },
  deepForest: {
    ...
    icon: "systems/ryuutama/assets/official/icons/terrains/deep-forest.webp",
    iconSmall: "systems/ryuutama/assets/official/icons/terrains/deep-forest-sm.webp",
  },
  swamp: {
    ...
    difficulty: 10,
    movementModifier: 1 / 2,
    icon: "systems/ryuutama/assets/official/icons/terrains/swamp.webp",
    iconSmall: "systems/ryuutama/assets/official/icons/terrains/swamp-sm.webp",
  },
  mountain: {
    ...
    difficulty: 10,
    movementModifier: 1 / 2,
    icon: "systems/ryuutama/assets/official/icons/terrains/mountain.webp",
    iconSmall: "systems/ryuutama/assets/official/icons/terrains/mountain-sm.webp",
  },
  desert: {
    ...
    icon: "systems/ryuutama/assets/official/icons/terrains/desert.webp",
    iconSmall: "systems/ryuutama/assets/official/icons/terrains/desert-sm.webp",
  },
  jungle: {
    ...
    difficulty: 12,
    movementModifier: 1 / 3,
    icon: "systems/ryuutama/assets/official/icons/terrains/jungle.webp",
    iconSmall: "systems/ryuutama/assets/official/icons/terrains/jungle-sm.webp",
  },
  alpine: {
    ...
    icon: "systems/ryuutama/assets/official/icons/terrains/alpine.webp",
